...
screen = pygame.display.set_mode((SCREEN_WIDTH + OFFSET, SCREEN_HEIGHT + 2 * OFFSET), pygame.RESIZABLE)
...
highscore_text_suface = font.render("HIGH-SCORE", False, yellow)
...
while True:
    ...
    # display high-score
    screen.blit(highscore_text_suface, (550, 15, 50, 50))
